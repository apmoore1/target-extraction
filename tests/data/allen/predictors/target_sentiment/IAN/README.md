To create the ian models that are stored within `./ian/model.tar.gz`, `./ian_target_sequences/model.tar.gz`, and `./inter_ian/model.tar.gz` run the following bash commands from the top of this project path:
``` bash
