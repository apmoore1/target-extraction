To create the models that are stored within `./tdlstm/model.tar.gz` and `./tclstm/model.tar.gz` run the following four bash commands from the top of this project path:
``` bash
