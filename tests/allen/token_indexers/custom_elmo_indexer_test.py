...
from target_extraction.allen.token_indexers import CustomELMoTokenCharactersIndexer

class TestCustomELMoTokenCharactersIndexer(AllenNlpTestCase):
    ...
    def test_elmo_indexer_with_additional_tokens(self):
        indexer = CustomELMoTokenCharactersIndexer(tokens_to_add={"<first>": 1})
        tokens = [Token("<first>")]
        indices = indexer.tokens_to_indices(tokens, Vocabulary())
        expected_indices = [
            [
    ...
    def test_elmo_empty_token_list(self):
        ...
        targets_2 = ListField([TextField([Token('Screen')], indexer),
        ...
        non_empty_targets = [elmo_target_token_indices[0][0],
